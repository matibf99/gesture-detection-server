...
class LandmarkPoints:
    ...
    FACE_TOP = FACE_OVAL[0]
    FACE_BOTTOM = FACE_OVAL[19]
    ...
    # Left eyebrow
    LEFT_EYEBROW_UPPER_MIDPOINT = LEFT_EYEBROW[2]
    LEFT_EYEBROW_LOWER_MIDPOINT = LEFT_EYEBROW[7]
    FACE_TOP_LEFT_EYEBROW = 297

    # Right eyebrow
    RIGHT_EYEBROW_UPPER_MIDPOINT = RIGHT_EYEBROW[2]
    RIGHT_EYEBROW_LOWER_MIDPOINT = RIGHT_EYEBROW[7]
    FACE_TOP_RIGHT_EYEBROW = 67
